...
public class DatabaseConfig {
	...
	public DataSource getDataSource() {
		final String BASE = System.getenv("SISFIN_DATABASE_MAINTENANCE_BASE");
		final String USER = System.getenv("SISFIN_DATABASE_MAINTENANCE_USER");
		final String PASS = System.getenv("SISFIN_DATABASE_MAINTENANCE_PASS");
